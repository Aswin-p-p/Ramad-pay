...
function WashingtonSeattle() {        const [currencies, setCurrencies] = useState([]);
                    ...
                    <div className="container">
                        <div className="cmpny-content cmpny-minne">
                            <h1 data-aos="fade-right" data-aos-duration="1000">
                                <span className="commSpn">Seattle's</span>
                                Link to Global <br />
                        ...
                        <div className="rmserArIn">
                            <div className="tite">
                                <h2>
                                    ...
                                    Connecting Seattle, WA to the World with Financial Ease

                                </h2>
                                <p>
                                    Seattle’s Answer to Worldwide Money Movement: Simple, Swift, Secure.
                                </p>
                            </div>
                                ...
                                <div className="aboutSection" data-aos="fade-right" data-aos-duration="1000">
                                    <div className="row abtRow">
                                        <div className="abt-content serArInCont col-md-12 col-lg-6">
                                            <div>
                                                <h3>Financial Innovation Starts in Seattle</h3>
                                                <p>
                                                    Seattle’s vibrant community now has the world at its fingertips, thanks to Ramad Pay’s diverse financial services. Catering to both individuals and businesses, we offer solutions that transform the way you engage with the global economy. Our services range from seamless P2P remittances, enabling personal connections across borders, to sophisticated B2B digital payment platforms designed for Seattle’s dynamic business environment. NGOs in Seattle benefit from our efficient financial tools, ensuring their efforts have a broader impact. With our Customized Ramad Pay App, experience the future of banking today, combining security with convenience. Ramad Pay is dedicated to making Seattle a hub of financial innovation and connectivity.
                                                </p>
                                            </div>
                                        </div>
...
export default WashingtonSeattle