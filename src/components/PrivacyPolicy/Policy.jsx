                ...
                <div className="PrvcyCnt">
                    ...
                    <div className="dataColl-list">
                        ...
                        <ul>
                            ...
                            <li>Usage Data: This includes IP address, browser type, pages visited, device identifiers, and diagnostic data.</li>
                            <li>Cookies and Tracking: We use cookies to track activity and improve Service functionality. </li>
                    ...
                    <div className="dataColl-list">
                        ...
                        <ul>
                            ...
                            <li>Provide customer support and notify users of updates</li>
                            <li>Track usage for analytics and to prevent technical issues</li>
                            <li>Share relevant offers and updates (unless you opt out)</li>
                    ...
                    <div className="prvcyCntTxt dataColl-list">
                        ...
                        <ul>
                            ...
                            <li>To cancel, send “STOP” at any time; we will send a confirmation SMS upon cancellation.</li>
                            <li>For remittance tracking, send “TRACK” to Ramad Pay to receive current status details via SMS.</li>
                            <li>By clicking this box, you agree to receive SMS from (Business name), you can reply stop to opt-out at any time, this is my Privacy Policy.</li>
                            <li>SMS opt-in or phone numbers for the purpose of SMS are not being shared.</li>
                    ...
                    <div className="dataColl-list">
                        ...
                        <p>Data Transfers</p>
                        <p id="prvTxt">Your data may be transferred to servers outside your jurisdiction. By using the Service, you agree to this transfer under appropriate security protocols.</p>

                        <p>Disclosure of Data</p>
                        <p id="prvTxt">We may disclose your data for legal compliance, security, and to protect our rights or as part of a business transfer.</p>

                        <p>Security</p>
                        <p id="prvTxt">While we strive to use secure data handling, no method of online storage or transmission is 100% secure.</p>

                        <p id="prvTxt">Your Rights under GDPREEA residents have rights to access, correct, delete, and limit use of personal data. For assistance, contact us at <a href="">privacy@ramadpay.com.</a> </p>
                        <p></p>
                    </div>
                </div>
            </div>
